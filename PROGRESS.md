...
**Sürüm `v1.0.1`** · 2026-08-12 — **Denetim-02** (eşzamanlılık ve veri bütünlüğü): 4 kırmızı + 1 turuncu + 4 sarı, **dokuzunun dokuzu da kapalı** (K-120..K-128); **471/471 test yeşil**. Ayrıntı: `raporlar/denetim-02.md`.
